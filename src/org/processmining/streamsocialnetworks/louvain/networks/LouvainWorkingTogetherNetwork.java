...
public class LouvainWorkingTogetherNetwork {
	boolean stop;
	...
	public LSocialNetworkClustered aggregation(TObjectDoubleMap<NodesPair> communityNetwork, Set<Set<Node>> communities) {
		...
		LSocialNetworkClustered newCommunityNetwork = new LSocialNetworkClustered(LSocialNetworkClustered.Type.WORKING_TOGETHER);
	...
	public LSocialNetworkClustered initializeNetwork(TObjectDoubleMap<ResourcesPair> network) {
		...
		LSocialNetworkClustered communityNetwork = new LSocialNetworkClustered(LSocialNetworkClustered.Type.WORKING_TOGETHER);
